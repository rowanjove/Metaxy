export const ERROR_CODES = {
  ...
  DRIVE_INVALID_NAME: "DRIVE_INVALID_NAME",
  DRIVE_PARENT_NOT_FOUND: "DRIVE_PARENT_NOT_FOUND",
  DRIVE_MOVE_CYCLE: "DRIVE_MOVE_CYCLE",
  DRIVE_UPLOAD_EXPIRED: "DRIVE_UPLOAD_EXPIRED",
  DRIVE_UPLOAD_INVALID: "DRIVE_UPLOAD_INVALID",
  DRIVE_QUOTA_EXCEEDED: "DRIVE_QUOTA_EXCEEDED",
  DAV_UNAUTHORIZED: "DAV_UNAUTHORIZED",
  DAV_LOCKED: "DAV_LOCKED",
  DAV_PRECONDITION_FAILED: "DAV_PRECONDITION_FAILED",
  DAV_METHOD_NOT_SUPPORTED: "DAV_METHOD_NOT_SUPPORTED",

  // Gallery errors
  GALLERY_IMAGE_NOT_FOUND: "GALLERY_IMAGE_NOT_FOUND",
  GALLERY_INVALID_IMAGE: "GALLERY_INVALID_IMAGE",
